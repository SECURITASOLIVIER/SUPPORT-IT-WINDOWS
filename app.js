...
let state=readLocalJson("ssitState",{cat:"Accueil",tabs:["Accueil"],theme:"dark"});
...
function render(){
 try{
   ...
   if(title)title.textContent=state.cat;
   if(stats)stats.textContent=pocketActions().length+" scripts/actions • "+allTemplates().length+" modèles";
   let c=state.cat, h=
     c==="Accueil"?home():
   ...
   state={cat:"Accueil",tabs:["Accueil"],theme:"dark"};
