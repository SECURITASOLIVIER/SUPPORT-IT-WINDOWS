...
const cats=["Accueil","Toutes les actions","Communications","Système","Sécurité Windows","Microsoft 365","Réseau & Accès distant","Intune / Entra / SCCM","Applications","Navigateurs","Périphériques & Pilotes","Windows Update","Outils Support","Portails"];
...
function home(){
 return '<div class="home-summary">'+
   ...
   '<article class="card home-kpi"><h3>🖥 Système</h3><div class="big-number">'+pocketActions().filter(x=>x.webCategory==="Système").length+'</div><p class="desc">Diagnostic, système et actions Windows.</p><button class="btn primary" onclick=\'openCat("Système")\'>Ouvrir</button></article>'+
