...
const cats=["Accueil","Toutes les actions","Communications","Diagnostic & Escalade","Poste Windows","Sécurité Windows","Microsoft 365","Réseau & Accès distant","Intune / Entra / SCCM","Applications","Navigateurs","Périphériques & Pilotes","Windows Update","Outils Support","Portails"];
...
function icon(c){return {"Accueil":"⌂","Toutes les actions":"☷","Diagnostic & Escalade":"🩺","Poste Windows":"🖥","Sécurité Windows":"🛡","Windows Update":"↻","Périphériques & Pilotes":"⌨","Réseau & Accès distant":"🌐","Microsoft 365":"▦","Applications":"📦","Navigateurs":"🌍","Intune / Entra / SCCM":"☁","Communications":"✉","Outils Support":"🧰","Portails":"↗","Journal & Statistiques":"📊"}[c]||"•"}
...
function home(){
 return '<div class="home-summary">'+
   '<article class="card home-kpi"><h3>☷ Scripts & actions</h3><div class="big-number">'+pocketActions().length+'</div><p class="desc">Tout le catalogue autonome.</p><button class="btn primary" onclick=\'openCat("Toutes les actions")\'>Ouvrir</button></article>'+
   '<article class="card home-kpi"><h3>🩺 Diagnostic</h3><div class="big-number">'+pocketActions().filter(x=>x.webCategory==="Diagnostic & Escalade").length+'</div><p class="desc">Diagnostic général du poste.</p><button class="btn primary" onclick=\'openCat("Diagnostic & Escalade")\'>Ouvrir</button></article>'+
